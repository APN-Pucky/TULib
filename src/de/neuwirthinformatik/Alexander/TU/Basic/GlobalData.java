...
public class GlobalData 
{
	...
	public static boolean isDominion(int dom_id)
	{
		...
		if(d==null){TU.log.w("NULL == DOM ||| UPDATE XMLS?!?! ||| "+ dom_id, "DATA");return false;}
	...
	public static boolean isFortress(int fort)
	{
		...
		if(d==null){TU.log.w("NULL == DOM ||| UPDATE XMLS?!?! ||| "+ fort, "DATA");return false;}
			...
			synchronized(c)
			{
				...
				try
				{
					if(!c.exists())
					{
						...
						{
							TU.log.e("Interruption in saving deck, manual restore needed", gaunt_name, "saveGauntletRaw");
